...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{pictures/uniformvscosine/compare_sampling_16.png}
		\caption{每像素随机采样16次}
		\label{fig:compare_sampling_16}
	\end{subfigure}
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{pictures/uniformvscosine/compare_sampling_50.png}
		\caption{每像素随机采样50次}
		\label{fig:compare_sampling_50}
	\end{subfigure}
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{pictures/uniformvscosine/compare_sampling_100.png}
		\caption{每像素随机采样100次}
		\label{fig:compare_sampling_100}
	\end{subfigure}
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{pictures/uniformvscosine/compare_sampling_1000.png}
		\caption{每像素随机采样1000次}
		\label{fig:compare_sampling_1000}
	\end{subfigure}
