...
\subsection{核心思想}
基于蒙特卡洛积分，我们要解决的问题仍然是估计：
\begin{equation}
	I = \int_\Omega f(x) \diff x.
\end{equation}

但是现在，我们有多种采样方式可供选择，假设我们有$m$种采样方式，概率分布分别为$p_i(x), i=1,2,\ldots,m$。

对于每一种采样方式，我们可以独立地进行采样，得到$n_i$个样本点$x_{i,1}, x_{i,2}, \ldots, x_{i,n_i}$。
...
至此，我们可以构造多重重要性采样的估计量\cite{Veach1995}为：
\begin{equation}
